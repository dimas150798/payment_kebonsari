                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-lg-3 mt-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-secondary"><i class="bi bi-upc-scan"></i></span>
                                    ...
                                    <div class="col-sm-12 col-lg-3 mt-4">
                                        <label for="" class="form-label fw-bold fs-5"> Nama Paket : <span class="text-danger">*</span></label>
                                        <div class="input-group">
