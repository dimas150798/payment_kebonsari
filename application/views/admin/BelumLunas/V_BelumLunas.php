        ...
        <div class="menuatas">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-12 col-xl-auto mt-2">
                    ...
                    <a class="btn buttonmenuatas" href="<?php echo base_url('admin/BelumLunas/C_BelumLunasDate') ?>"><img src="<?php echo base_url(); ?>vendor/bootstrap-icons/icons/search.svg" alt="Bootstrap" ...> Filter
                    </a>
                </div>
            </div>
        </div>
